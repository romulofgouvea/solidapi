...
<h2 align="center">
  <img alt="Banner" src="./images/l-1.png" />
  <img alt="Banner" src="./images/l-2.png" />
  <img alt="Banner" src="./images/l-3.png" />
  <img alt="Banner" src="./images/l-4.png" />
</h2>
...
Esse princípio defende basicamente que você não crie interfaces que são muito robustas com várias propriedades, e sim dividas essas interfaces em interfaces menores, em tipagens menores. Várias interfaces somadas que definiriam o objeto como um todo, com todas as propriedades que ele precisa. Exemplo: jogador, jogador de futebol, atacante, goleiro... </br>

Não deve forçar classes a dependerem de métodos que eles não usam.

<h2 align="center">
  <img alt="Banner" src="./images/i-1.png" />
...
<h2 align="center">
  <img alt="Banner" src="./images/d-1.png" />
</h2>

Ferramenta está fundida com o usuário, assim como o Edwards Mãos de Tesoura. Se algum dia eu precisar de alterar a ferramenta, isso será um problema.
